...
class TestMd2html(unittest.TestCase):
    ...
    def test_to_b64(self):
        ...
        self.assertIsNotNone(md2html.to_b64(local_image))
        self.assertIsNotNone(md2html.to_b64(remote_image))
        self.assertEqual(md2html.to_b64(local_image),
                         md2html.to_b64(remote_image))
        self.assertIsNone(md2html.to_b64('nonexisting_file.png'))
        self.assertIsNone(md2html.to_b64('http://localhost/nofile.jpg'))
        self.assertIsNone(md2html.to_b64('http://wrong.url/img.png'))
